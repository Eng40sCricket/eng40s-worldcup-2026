...
export const squadData = {
  ...
  players: [
    ...
    },
    {
      ...
      shortBio: 'A prolific English all-rounder and mainstay of Harold Wood Cricket Club in the Essex League. A consistent performer with both bat and ball, he has earned multiple Player of the Year awards and surpassed 10,000 career runs. His exceptional domestic form led to his selection for the England Over-40s squad for the 2026 World Cup in Guyana.',
      profileStatus: 'confirmed',
      squadNumber: 12,
    },
    {
      ...
      shortBio: 'A former cricketer who played for Hertfordshire and represented the Marylebone Cricket Club (MCC) on a tour to Argentina. In 2024, he played for England in the IMC Over-40 World Cup, reaching the semi-finals.',
      profileStatus: 'confirmed',
      squadNumber: 17,
    },
    {
      ...
      shortBio: 'A seasoned wicketkeeper-batsman from South Africa, known for his extensive first-class career with Western Province, Cape Cobras, and Boland. Over 300 first-class dismissals as a wicketkeeper. 105 first-class matches, 5,084 runs (avg 37.38, 9x100s, 29x50s), 318 catches and 27 stumpings.',
      profileStatus: 'confirmed',
      squadNumber: 22,
    },
    {
      ...
      wicketkeeperFlag: false,
      clubEngland: 'Lindow',
      shortBio: 'A consistent and high-performing batter, James Duffy has been a crucial player for Lindow and England Over 40s Cricket. Known for his determination, he has also represented Hyde and Chester Boughton Hall Cricket Club, showcasing significant contributions across English club cricket.',
      profileStatus: 'confirmed',
      squadNumber: 15,
    },
    {
    ...
    },
    {
      ...
      shortBio: 'A distinguished English cricketer, known for his prolific batting in the Sussex Cricket League, including a record-breaking 1,082 runs in 2005. A stalwart for Middleton CC, he scored a century (100*) for England Over 40s against Wales in 2025, showcasing his enduring talent and commitment to the sport.',
      profileStatus: 'confirmed',
      squadNumber: 27,
    },
    {
      ...
      shortBio: 'South African-born right-hander and former Wiltshire and Unicorns List A batter, now captains Bromsgrove CC, where he has amassed over 19,000 runs at 41, including 46 centuries and a 74-average 2025 season, marking him as a prolific, match-winning club star.',
      profileStatus: 'confirmed',
      squadNumber: 55,
    },
    {
      ...
      shortBio: 'An English cricketer with a notable career in county cricket. A right-handed batsman and right-arm fast-medium bowler, he has represented Huntingdonshire, Buckinghamshire, and Berkshire, accumulating significant experience in Minor Counties Championship and List A matches. 6 List A matches, 51 runs and 5 wickets (avg 42.40, BB 3/28).',
      profileStatus: 'confirmed',
      squadNumber: 77,
    },
    {
      ...
      shortBio: 'Born in South Africa, Garry Park enjoyed a notable career with Durham and Derbyshire, making a first-class century debut for Durham in 2006. He later excelled for Derbyshire, scoring over 1,000 runs in his first season (2009). He has also proudly represented England Over-40s.',
      profileStatus: 'confirmed',
      squadNumber: 9,
    },
    {
      ...
      shortBio: 'A South African-born English cricketer, a right-handed batter and right-arm medium-fast bowler. He has represented Unicorns and England Over-40s, participating in the 2024 Over-40s World Cup in South Africa. Formerly a Cambridgeshire all-rounder, he is currently Head of Cricket at The Perse School, Cambridge.',
    ...
    },
    {
      ...
      shortBio: 'A seasoned slow left-arm orthodox bowler from India, known for his domestic career with Bengal and a stint with Kolkata Knight Riders in the IPL. He has also made a significant impact in English club cricket with Totteridge Millhillians, and has multiple 6-wicket hauls to his name.',
      profileStatus: 'confirmed',
      squadNumber: 14,
    },
    {
      ...
      shortBio: 'A Zimbabwean all-rounder who represented his country in ODIs. He has extensive experience in English club cricket, currently playing for Swardeston CC. 21 first-class matches, 1,325 runs (avg 36.80, 2x100s, 8x50s) and 30 wickets. He also coaches cricket, hockey, and rugby at Norwich School.',
      profileStatus: 'confirmed',
      squadNumber: 90,
    },
    {
      ...
      shortBio: 'A formidable right-arm pace bowler and legend at South Northumberland CC. Leading wicket-taker for England Over 40s (25 wickets in 13 games, BB 5-24). Over 500 NEPL wickets (avg 18.64, 22x5-wicket hauls, BB 8-31). NEPL Player of the Year 2014 and part of 16 trophy-winning campaigns.',
      profileStatus: 'confirmed',
      squadNumber: 11,
    },
    {
      ...
      shortBio: 'A Level 3 ECB coach with extensive playing and coaching experience in both Australia and the UK. Over 20 years and 300 wickets in New South Wales Premier Cricket first grade, one of the most competitive leagues in the world. Also played for Sutherland DCC (Australia) and Beaconsfield CC (UK).',
      profileStatus: 'confirmed',
      squadNumber: 43,
    },
    {
      ...
      shortBio: 'An experienced cricket coach and former player. He captained Bishop\'s Stortford and Hoddesdon Cricket Clubs for over 14 years, played for Hertfordshire, Hampshire 2nd XI, and Surrey 2nd XI, and has coaching experience in South Africa. Head of Cricket at Bishop\'s Stortford College.',
    ...
    },
    {
      ...
      shortBio: 'A former English cricketer who represented Sussex and Surrey at first-class county level. He also played for England U-19s, notably against West Indies Young Cricketers. A right-handed batsman and off-break bowler, Chris retired from county cricket to pursue a medical career as a GP for 30 years.',
