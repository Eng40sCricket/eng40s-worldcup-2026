...
export const squadData = {
  ...
  players: [
    ...
    },
    {
      ...
      shortBio: 'A Level 3 ECB coach with extensive playing and coaching experience in both Australia and the UK. He boasts a distinguished career, including over 20 years and 300 wickets in New South Wales Premier Cricket first grade, alongside significant contributions to English club cricket. Played for and coached Sutherland DCC (Australia). Played for Beaconsfield and Normandy CC (UK).',
      profileStatus: 'confirmed',
      squadNumber: 43,
    },
    {
